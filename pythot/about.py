...
class Ui_about(object):
    def setupUi(self, about):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/thot.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
