...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.about.setText("")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/thot.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/plus.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_num.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/minus.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.sub_num.setIcon(icon13)
        ...
        self.add_x.setText("")
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/plus-x.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_x.setIcon(icon14)
        ...
        self.sub_x.setText("")
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/minus-x.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.sub_x.setIcon(icon15)
        ...
        self.mult.setText("")
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/times.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mult.setIcon(icon16)
        ...
        self.div.setText("")
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/div.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.div.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/exchange.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.exchange.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/opposite.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.opposite.setIcon(icon19)
        ...
        self.cancel.setText("")
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons/cancel.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cancel.setIcon(icon20)
        ...
        self.actionAjouter_un_nombre.setIcon(icon12)
        ...
        self.actionSoustraire_un_nombre.setIcon(icon13)
        ...
        self.actionAjouter_un_terme_en_x.setIcon(icon14)
        ...
        self.actionSoustraire_un_terme_en_x.setIcon(icon15)
        ...
        self.actionMultiplier_par_un_nombre.setIcon(icon16)
        ...
        self.actionDiviser_par_un_nombre.setIcon(icon17)
        ...
        self.actionIntervertir_les_deux_membres.setIcon(icon18)
        ...
        self.actionA_propos.setIcon(icon11)
